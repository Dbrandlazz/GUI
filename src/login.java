...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setFont(new java.awt.Font("Noto Sans", 0, 18));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("ATM Bank Informatika");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // Apabila Login Sukses, Maka Masuk Menu Utama
        new BankATM().show();
        this.dispose(); }
        else {
        // Apabila Login Gagal, Maka Ulangi Login
        JOptionPane.showMessageDialog(rootPane, "Password Salah, Silahkan Coba Lagi");
        vpassword.setText("");
        vpassword.requestFocus(); }}
        else {
        JOptionPane.showMessageDialog(rootPane, "Username Tidak Ditemukan, Silahkan Coba Lagi");
        vusername.setText("");
        vpassword.setText("");
